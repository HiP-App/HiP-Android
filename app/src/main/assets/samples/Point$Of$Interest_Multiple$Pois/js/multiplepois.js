...
//		if(marker.poiData.id < 10){
//			document.getElementById('poi-detail-image').src = "assets/Liboribrunnen.jpg";
//		} else {
//			document.getElementById('poi-detail-image').src = "assets/Dom.jpg";
//		}
