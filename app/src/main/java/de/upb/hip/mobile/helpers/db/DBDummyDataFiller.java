...
public class DBDummyDataFiller {
    ...
    public void insertData() {
        ...
        kaiserpfalzPages.add(new ImagePage(new Image(1, "Die Überreste der Kaiserpflaz von Westen aus betrachtet.", "kaiserpfalz_teaser.jpg", "Die Pfalz Karls des Großen"), null, null, audio1));
        kaiserpfalzPages.add(new ImagePage(new Image(1, "Die Überreste der Kaiserpflaz mit rot eingefärbten Mauern der aula regia von Westen aus betrachtet.", "kaiserpfalz_image_2.jpg", "Von Westen aus betrachtet"), null, null, audio2_1));
        ...
        sliderTimes1.add(3L);
        slider1.add(new Image(1, "Blick von Norden um 1945", "kaiserpfalz_slider_1_5.jpg", "Img1"));
        sliderTimes1.add(4L);
        kaiserpfalzPages.add(new TimeSliderPage("Gelände nördlich des Doms", "Fotografien des Geländes nördlich des Domes, zu Beginn des 20. Jh., in den 1930er Jahren, in den 1950er Jahren und während der Grabung. \n[Bildnachweis: Gai / Mecke 2004, S. 8, Abb. 5 und 6, S. 9, Abb. 7, S. 14, Abb. 11, S. 15, Abb. 12]", audio2_2, sliderTimes1, slider1, true));


        kaiserpfalzPages.add(new ImagePage(new Image(1, "Die vermutliche Ausdehnung der Befestigungsanlage in karolingischer Zeit. \n[Bildnachweis: Gai / Mecke 2004, Bd. 1, S. 102, Abb. 51]", "kaiserpfalz_image_3_1.jpg", "Befestigungsanlage"), null, null, audio3_1));
        kaiserpfalzPages.add(new ImagePage(new Image(1, "Blick vom Dom auf die Grabungsfläche der Paderborner Pfalz. \n[Bildnachweis: 799. Kunst und Kultur der Karolingerzeit. Karl der Große und Papst Leo III. in Paderborn. Beiträge zum Katalog der Ausstellung Paderborn 1999, Mainz 1999, S. 178, Abb. 3]", "kaiserpfalz_image_3_2.jpg", "Blick auf die Grabungsfläche"), null, null, audio3_2));
        kaiserpfalzPages.add(new ImagePage(new Image(1, "Plan der Bauphasen der Paderborner Kaiserpfalz. \n[Bildnachweis: Gai / Mecke 2004, Bd. 1, S. 108]", "kaiserpfalz_image_4.jpg", "Plan der Bauphasen"), null, null, audio4));
        kaiserpfalzPages.add(new ImagePage(new Image(1, "Rekonstruktion der Aula , Bauphase Ib. \n[Bildnachweis: Gai / Mecke 2004, S. 120, Abb. 68]", "kaiserpfalz_image_5_1.jpg", "Rekonstruktion der Aula"), null, null, audio5_1));
        kaiserpfalzPages.add(new ImagePage(new Image(1, "Grundrisses der Salvatorkirche. \n[Bildnachweis: Gai / Mecke 2004, Bd. 1, S. 108]", "kaiserpfalz_image_5_2.jpg", "Grundriss der Salvatorkirche"), null, null, audio5_2));
        kaiserpfalzPages.add(new ImagePage(new Image(1, "Rekonstruktion der Salvatorkirche. \n[Bildnachweis: Gai / Mecke 2004, Bd. 1, S. 122]", "kaiserpfalz_image_5_3.pg", "Rekonstruktion der Salvatorkirche"), null, null, audio5_3));
        kaiserpfalzPages.add(new ImagePage(new Image(1, "Plan der karolingischen Pfalzanlage um 800. \n[Bildnachweis: Gai / Mecke 2004, Bd. I, S. 132, Abb. 77]", "kaiserpfalz_image_7_1.jpg", "Karolingische Pfalzanlage"), null, null, audio7_1));


        List<Image> slider2 = new LinkedList<>();
        List<Long> sliderTimes2 = new LinkedList<>();
        slider2.add(new Image(1, "Pfalzanlage Paderborn (Bauhhase II, 799)", "kaiserpfalz_slider_7_1.jpg", "Img1"));
        sliderTimes2.add(0L);
        slider2.add(new Image(1, "Aachen, die karolingische Pfalz, erhaltene Fundamente. \n[Bildnachweis: Keller, Christoph : Archäologische Forschungen in Aachen, Mainz 2004, S. 52]", "kaiserpfalz_slider_7_2.jpg", "Img1"));
        sliderTimes2.add(1L);
        slider2.add(new Image(1, "Schematischer Gesamtplan des karolingischen Zustands der Pfalz von Ingelheim am Rhein, um 800. \n" +
                "[Bildnachweis: Untermann, Matthias : Architektur im frühen Mittelalter, Darmstadt 2006, S. 119, Abb. 105]", "kaiserpfalz_slider_7_3.jpg", "Img1"));
        sliderTimes2.add(2L);
        kaiserpfalzPages.add(new TimeSliderPage("Grundrisse", "Maßstabsgetreue Grundrisse der Pfalzanlagen in Paderborn, Aachen und Ingelheim.", audio7_2, sliderTimes2, slider2, true));


        kaiserpfalzPages.add(new ImagePage(new Image(1, "Entdecken Sie im Museum in der Kaiserpfalz Fundstücke aus der karolingischen Pfalzanlage!", "kaiserpfalz_teaser.jpg", "Museum in der Kaiserpfalz"), null, null, audio8));
