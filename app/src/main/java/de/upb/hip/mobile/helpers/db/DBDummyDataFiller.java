...
public class DBDummyDataFiller {
    ...
    private static final Audio audio6 = new Audio(R.raw.sprechertext_6, "Neben diesen beiden Steinbauten gibt es in der frühen Pfalzanlage auch Hinweise für zahlreiche Holzbauten und die Anwesenheit verschiedener Handwerker, unter ihnen Maurer, Steinmetze, Schmiede, Glasmacher und Bleigießer.  Besonders während der 770er Jahre waren diese Handwerker unentbehrlich. Sie halfen beim Bau der Anlage und zogen später weiter zu neuen Auftraggebern – die Mobilität der Menschen zu dieser Zeit ist nicht zu unterschätzen!\n" +
            "Viele Handwerker wurden wieder gegen Ende des 8. Jahrhunderts gebraucht. Damals beschloss man nämlich die Erweiterung der aula regia. Im Nordwesten wurde ein steinerner Wohntrakt angebaut.  Die Salvatorkirche wurde durch die „ecclesiam mira[e] magnitudinis“,  das heisst eine „Kirche von wunderbarer Größe“ ersetzt. Die nun der Gottesmutter und dem hl. Kilian geweihte Kirche maß tatsächlich 21 x 42,7m und gehörte somit zu den großen Kirchenbauten des Frankenreiches, vergleichbar etwa der Klosterkirche in Lorsch oder der Abteikirche in Saint-Denis.");
    ...
    public void insertData() {
        ...
        kaiserpfalzPages.add(new ImagePage(new Image(1, text1, "kaiserpfalz_image_4.jpg", "Kaiserpfalz"), null, null, audio4_2));
        kaiserpfalzPages.add(new ImagePage(new Image(1, text1, "kaiserpfalz_image_5_1.jpg", "Kaiserpfalz"), null, null, audio5_1));
        kaiserpfalzPages.add(new ImagePage(new Image(1, text1, "kaiserpfalz_image_5_2.jpg", "Kaiserpfalz"), null, null, audio5_2));
